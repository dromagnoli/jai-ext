...
public class Scale2CRIF extends CRIFImpl {
    ...
    public RenderedImage create(ParameterBlock paramBlock, RenderingHints renderHints) {
        ...
        if (xScale == 1.0D && yScale == 1.0D && xTrans == 0.0D && yTrans == 0.0D
        ...
        if (xScale == 1.0D && yScale == 1.0D && (Math.abs(xTrans - (int) xTrans) < TOLERANCE)
        ...
        boolean isBinary = (sm instanceof MultiPixelPackedSampleModel) && (sm.getSampleSize(0) == 1)
