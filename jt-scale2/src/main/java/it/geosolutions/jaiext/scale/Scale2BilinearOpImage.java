...
public class Scale2BilinearOpImage extends Scale2OpImage {
    ...
    public Scale2BilinearOpImage(RenderedImage source, ImageLayout layout, Map configuration,
            BorderExtender extender, Interpolation interp, double scaleX, double scaleY,
            double transX, double transY, boolean useRoiAccessor, Range nodata, double[] backgroundValues) {
